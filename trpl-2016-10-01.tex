...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{$ }\KeywordTok{./main}  \CommentTok{# or .\textbackslash{}main.exe on Windows}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{thread} \StringTok{'main'} \NormalTok{panicked at }\StringTok{'Some tests failed'}\NormalTok{, /home/steve/src/rust/src/libtest/lib.rs}
\NormalTok{↳ :}\KeywordTok{247}
\end{Highlighting}
\end{Shaded}
