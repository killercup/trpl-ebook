...
[installing-rust.md--install page]: #sec--http://www.rust-lang.org/install
...
[hello-cargo.md--crates-custom]: #configuring-a-target
...
[hello-cargo.md--guide]: #sec--http://doc.crates.io/guide
...
[guessing-game.md--prelude]: #sec--http://doc.rust-lang.org/std/prelude/index
...
[guessing-game.md--string]: #sec--http://doc.rust-lang.org/std/string/struct.String
...
[guessing-game.md--iostdin]: #sec--http://doc.rust-lang.org/std/io/struct.Stdin
...
[guessing-game.md--ioresult]: #sec--http://doc.rust-lang.org/std/io/type.Result
[guessing-game.md--result]: #sec--http://doc.rust-lang.org/std/result/enum.Result
...
[guessing-game.md--cargodoc]: #sec--http://doc.crates.io/crates-io
...
[guessing-game.md--doccratesio]: #sec--http://doc.crates.io/crates-io
...
[guessing-game.md--ordering]: #sec--http://doc.rust-lang.org/std/cmp/enum.Ordering
...
[dining-philosophers.md--poison]: #poisoning
...
[the-stack-and-the-heap.md--box]: #sec--http://doc.rust-lang.org/std/boxed/index
...
The [`Borrow`][borrow] and [`AsRef`][borrow-and-asref.md--asref] traits are very similar, but
different. Here’s a quick refresher on what these two traits mean.

[borrow-and-asref.md--borrow]: #sec--http://doc.rust-lang.org/std/borrow/trait.Borrow
[borrow-and-asref.md--asref]: #sec--http://doc.rust-lang.org/std/convert/trait.AsRef
...
For example, [`HashMap`][hashmap] has a [`get` method][borrow-and-asref.md--get] which uses `Borrow`:
...
[borrow-and-asref.md--hashmap]: #sec--http://doc.rust-lang.org/std/collections/struct.HashMap
...
[variable-bindings.md--format]: #sec--http://doc.rust-lang.org/std/fmt/index
...
[primitive-types.md--bool]: #sec--http://doc.rust-lang.org/std/primitive.bool
...
[primitive-types.md--char]: #sec--http://doc.rust-lang.org/std/primitive.char
...
[primitive-types.md--array]: #sec--http://doc.rust-lang.org/std/primitive.array
...
[primitive-types.md--slice]: #sec--http://doc.rust-lang.org/std/primitive.slice
...
[primitive-types.md--str]: #sec--http://doc.rust-lang.org/std/primitive.str
...
[primitive-types.md--tuple]: #sec--http://doc.rust-lang.org/std/primitive.tuple
...
[ownership.md--vect]: #sec--http://doc.rust-lang.org/std/vec/struct.Vec
...
[mutability.md--arc]: #sec--http://doc.rust-lang.org/std/sync/struct.Arc
...
[ownership][ownership] system, and more specifically, [borrowing][mutability.md--borrowing]:
...
[mutability.md--stdcell]: #sec--http://doc.rust-lang.org/std/cell/index
...
bindings][bindings], [match statements][patterns.md--match], and other places, too. Let’s go
...
[tuples][tuples] or [enums][patterns.md--enums].
...
[vectors.md--vec]: #sec--http://doc.rust-lang.org/std/vec/index
...
[traits.md--write]: #sec--http://doc.rust-lang.org/std/io/trait.Write
...
[drop.md--drop]: #sec--http://doc.rust-lang.org/std/ops/trait.Drop
...
[drop.md--arc]: #sec--http://doc.rust-lang.org/std/sync/struct.Arc
...
[trait-objects.md--stdraw]: #sec--http://doc.rust-lang.org/std/raw/struct.TraitObject
...
[attributes.md--reference]: #attributes
...
[type-aliases.md--ioresult]: #sec--http://doc.rust-lang.org/std/io/type.Result
...
[operators-and-overloading.md--stdops]: #sec--http://doc.rust-lang.org/std/ops/index
...
[operators-and-overloading.md--add]: #sec--http://doc.rust-lang.org/std/ops/trait.Add
...
[deref-coercions.md--deref]: #sec--http://doc.rust-lang.org/std/ops/trait.Deref
...
[macros.md--their own little grammar]: #macros
...
[macros.md--a GNU C extension]: #sec--https://gcc.gnu.org/onlinedocs/gcc/Statement-Exprs
...
[raw-pointers.md--rawapi]: #sec--http://doc.rust-lang.org/std/primitive.pointer
...
[unsafe.md--noalias]: #noalias
[unsafe.md--undef]: #undefined-values
[unsafe.md--aliasing]: #pointer-aliasing-rules
...
[nightly-rust.md--stability]: #sec--http://blog.rust-lang.org/2014/10/30/Stability
...
[nightly-rust.md--install page]: #sec--http://www.rust-lang.org/install
...
(a silly nickname we call ourselves), and we can help you out. Other great
resources include [the user’s forum][users], and [Stack Overflow][nightly-rust.md--stack overflow].
...
[nightly-rust.md--stack overflow]: http://stackoverflow.com/questions/tagged/rust
