...
with a [`[lib]` or `[[bin]]`][hello-cargo.md--crates-custom] key in the TOML file.
...
[`Box<T>`][choosing-your-guarantees.md--box] is pointer which is &ldquo;owned&rdquo;, or a &ldquo;box&rdquo;. While it can hand
